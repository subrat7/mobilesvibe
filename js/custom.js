...
/* _____________________________________
    ...
    if (pageAmplitude.length) {
      ...
      if (!isMobile && !isTouch) {
        var sound = new Howl({
          src: ['audio/mobiles-vibe.webm', 'audio/mobiles-vibe.mp3'],
          autoplay: true,
          loop: true
        });
    ...
    if (form.length) {
      form.ajaxChimp({
        ...
        url: 'https://mobiles-vibe.us13.list-manage.com/subscribe/post?u=0d5d3b57e890f53491f92e353&amp;id=27fdfeeb31'
      });
    }
